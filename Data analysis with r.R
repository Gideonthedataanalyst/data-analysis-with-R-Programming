...
# Adjust margins and set a single plot layout
...
# Open a new graphics window (optional)
if (.Platform$OS.type == "windows") windows()  # For Windows
if (.Platform$OS.type == "unix") x11()         # For Linux/macOS

# Set layout for grouped histograms
par(mfrow = c(3, 1))
...
pdf("Histograms.pdf", width = 7, height = 5)
hist(iris$Sepal.Length,
     main = "Histogram of Sepal Length",
     xlab = "Sepal Length",
     col = "lightblue")
